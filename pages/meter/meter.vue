<template>
  <view>
    ...
    <view v-if="noData == false || machines.length > 0" style="padding-bottom: 200rpx">
      <view class="cu-list menu" v-for="(machine, idx) in machines" :key="idx" :data-item="machine" @click="_preStoreWeterFee(machine)">
