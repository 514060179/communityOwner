            ...
            <view class="cu-item">
              <view class="content padding-tb-sm">
                ...
                <view class="text-gray text-sm padding-left">
                  ...
                  <text class="iconfont iconyuedu padding-left"></text> {{ item.readCount }} <text class="iconfont icongood-fill padding-left"></text> {{ item.likeCount }}
                </view>
              </view>
            </view>
          </view>
...
export default {
  ...
  onLoad: function (options) {
    ...
    this.vc.recoveryCommunityInfo(_that).then(_communityInfo => {
