<template>
  <view>
    <scroll-view scroll-y>
      <view class="block__title">{{ $t('车位信息-h2R') }}</view>
      <view class="cu-list menu">
        <view class="cu-item">
          <view class="content">
            <text class="text-grey">{{ $t('小区-Gal') }}</text>
          </view>
          <view class="action">
        ...
        <view class="cu-item">
          <view class="content">
            <text class="text-grey">{{ $t('车位编号-9Fd') }}</text>
          </view>
          <view class="action">
            <text class="text-grey text-sm">{{ num }}{{ $t('号车位-wN8') }}</text>
          </view>
        </view>
        <view class="cu-item">
          <view class="content">
            <text class="text-grey">{{ $t('车位类型-1vJ') }}</text>
          </view>
          <view class="action">
        ...
        <view class="cu-item">
          <view class="content">
            <text class="text-grey">{{ $t('车牌号-c9W') }}</text>
          </view>
          <view class="action">
      ...
      <view class="cu-list menu fee-last">
        ...
        <view class="cu-item" v-if="feeFlag == '1003006'">
          ...
          <view class="action">
            <text class="text-grey text-sm">{{ feePrice }}MOP/{{ $t('月-jmQ') }}</text>
          </view>
        </view>
        <view class="cu-item" v-else>
          ...
          <view class="action">
            <text class="text-grey text-sm">MOP {{ feePrice }}</text>
          </view>
        </view>
        ...
        <gift-coupon ref="giftCoupon" />
        <vcUserAccount ref="vcUserAccountRef" @getUserAmount="getUserAmount" v-if="false" />
        <vc-discount
ref="vcDiscountRef"
...
export default {
  ...
  onLoad: function (options) {
    ...
    const _receivableAmount = _fee.paymentCycle * _fee.feePrice
