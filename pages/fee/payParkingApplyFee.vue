    ...
    <scroll-view scroll-y>
      ...
      <view class="cu-list menu fee-last">
        ...
        <view class="cu-item" v-if="feeFlag == '1003006'">
          ...
          <view class="action">
            <text class="text-grey text-sm">{{ feePrice }}MOP/{{ $t(月) }}</text>
          </view>
        </view>
        ...
        <vc-discount ref="vcDiscountRef" @computeFeeDiscount="computeFeeDiscount" :feeId="feeId" :cycles="feeMonth" :communityId="communityId" />
      </view>
    </scroll-view>
...
export default {
  ...
  onLoad: function (options) {
    ...
    getCurCommunity().then(function (_communityInfo) {
  ...
  methods: {
    ...
    dateChange: function (e) {
      ...
      const _receivableAmount = _feeMonth * this.feePrice
