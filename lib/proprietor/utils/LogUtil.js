...
export function debug(fileName,method,msg) {
	//if (logLevel == DEBUG) {
		console.log(formatTimeNow()+' ' + '[newLand-debug] - ' + fileName + ':'+method+' ',msg);
	//}
}
...
export function info(fileName,method,msg) {
	if (logLevel == DEBUG || logLevel == INFO) {
		console.log(formatTimeNow()+' ' + '[newLand-info] - ' + fileName + ':'+method+' ' +msg);
	}
}
...
export function warn(fileName,method,msg) {
	if (logLevel == DEBUG || logLevel == INFO || logLevel == WARN) {
		console.log(formatTimeNow()+' ' + '[newLand-warn] - ' + fileName + ':'+method+' ' +msg);
	}
}
...
export function error(fileName,method,msg) {
		console.error(formatTimeNow()+' ' + '[newLand-error] - ' + fileName + ':'+method+' ' +msg);
}
