  ...
  <view class="uni-datetime-picker">
      ...
      <slot>
        <view class="uni-datetime-picker-timebox-pointer" :class="{ 'uni-datetime-picker-disabled': disabled, 'uni-datetime-picker-timebox': border }">
          ...
          <view v-if="!time" class="uni-datetime-picker-time">
            <text class="uni-datetime-picker-text">{{ $t('选择-kyQ') }}{{ title }}</text>
          </view>
        </view>
      </slot>
    </view>
    ...
    <view v-if="visible" class="uni-datetime-picker-popup" :class="[dateShow && timeShow ? '' : 'fix-nvue-height']" :style="fixNvueBug">
      <view class="uni-title">
        <text class="uni-datetime-picker-text">{{ $t('设置-LXV') }}{{ title }}</text>
      </view>
      ...
      <view class="uni-datetime-picker-btn">
        <view @click="clearTime">
          <text class="uni-datetime-picker-btn-text">{{ $t('清空-mYn') }}</text>
        </view>
        <view class="uni-datetime-picker-btn-group">
          <view class="uni-datetime-picker-cancel" @click="tiggerTimePicker">
            <text class="uni-datetime-picker-btn-text">{{ $t('取消-KvD') }}</text>
          </view>
          <view @click="setTime">
            <text class="uni-datetime-picker-btn-text">{{ $t('确定-vdT') }}</text>
          </view>
        </view>
      </view>
    </view>
