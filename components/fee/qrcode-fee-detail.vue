  ...
  <view>
    <view v-for="(item, index) in feeDetails" :key="index" class="bg-white margin-bottom margin-right-xs radius margin-left-xs padding">
      ...
      <view class="flex margin-top justify-between">
        <view class="text-gray">{{ $t('收费对象-FYy') }}</view>
      ...
      <view class="flex margin-top-xs justify-between">
        <view class="text-gray">{{ $t('缴费金额-QOt') }}</view>
...
<script>
import { getPayFeeDetailQrcode } from '@/api/fee/qrCodePayFee.js'
// import { dateSubOneDay } from '../../lib/proprietor/utils/DateUtil.js'
