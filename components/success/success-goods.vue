<template>
  <view>
    <view class="home_swiper margin-top-sm" v-if="goodsList && goodsList.length > 0">
      <text class="text-gray padding-sm">{{ $t('为您推荐-QcT') }}</text>
...
<script>
import { listCommunityMarketGoods } from '../../api/index/indexApi.js'
...
export default {
  ...
  methods: {
    _loadAdvertGoods: function () {
      ...
      //查询 广告
      listCommunityMarketGoods(_objData).then(function (_aPhotos) {
